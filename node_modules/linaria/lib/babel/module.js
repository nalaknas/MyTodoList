...
class Module {
  constructor(_filename, options, debuggerDepth = 0) {
    ...
    _defineProperty(this, "resolve", id => {
    ...
    _defineProperty(this, "require", Object.assign(id => {
      ...
      (_this$dependencies = this.dependencies) == null ? void 0 : _this$dependencies.push(id);
      let cacheKey = filename;
      let only = [];

      if ((_this$imports = this.imports) == null ? void 0 : _this$imports.has(id)) {
  ...
  evaluate(text, only = null) {
    ...
    const cacheKey = [this.filename, ...(only != null ? only : [])];
