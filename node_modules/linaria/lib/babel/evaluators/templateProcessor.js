...
function getTemplateProcessor({
  ...
  return function process({
    ...
    const [slug, displayName, className] = (0, _getLinariaComment.default)(path);
      ...
      if (ex) {
        ...
        if (result.confident) {
          ...
          if (options.evaluate && !(t.isFunctionExpression(ex) || t.isArrowFunctionExpression(ex))) {
            ...
            (0, _throwIfInvalid.default)(value, ex); // Skip the blank string instead of throwing an error
    ...
    state.rules[selector] = {
      ...
      start: (_path$parent$loc$star = (_path$parent = path.parent) == null ? void 0 : (_path$parent$loc = _path$parent.loc) == null ? void 0 : _path$parent$loc.start) != null ? _path$parent$loc$star : null
    };
  };
}
